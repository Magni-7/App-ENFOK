...
export const metadata: Metadata = {
  title: "Crear cuenta profesional — Trenzame",
};
...
const ERROR_MESSAGES: Record<string, string> = {
  name_required: "Por favor indica el nombre de tu salón o el tuyo.",
...
export default async function AdminRegistroPage({ searchParams }: RegistroPageProps) {
  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col gap-6 py-16">
      <div>
        <h1 className="font-serif text-2xl font-semibold tracking-tight">Crear cuenta profesional</h1>
        <p className="mt-2 text-sm text-ink/70">
          Regístrate para publicar tu salón, tu galería de trabajos y gestionar tus citas.
        </p>
      </div>
      ...
      <form action={registerProfessional} className="flex flex-col gap-4">
